...
kubectl --namespace=development exec spring-boot-1542459216-22d20 -- printenv | grep SERVICE

# Scale down and scale up
kubectl --namespace=development scale deployment spring-boot --replicas=0; kubectl --namespace=development scale deployment spring-boot --replicas=2;
...
# wget --spider --timeout=1 spring-boot
